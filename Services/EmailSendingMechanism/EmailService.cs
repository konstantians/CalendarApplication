...
namespace Services.EmailSendingMechanism
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public bool SendEmail(string emailSender, string emailReceiver, string title, string body)
        {
        ...
        /// <param name="body">The context of the email</param>
        /// <returns>Confirmation on whether or not the email was send successfully</returns>
        public bool SendEmail(string emailReceiver, string title, string body)
        {
            SmtpSettings? smtpSettings = Configuration.GetSection("SmtpSettings").Get<SmtpSettings>();
        ...
        /// <returns>Confirmation on whether or not the email was send successfully</returns>
        public bool SendContactFormEmail(string emailSender, string title, string body)
        {
            SmtpSettings? smtpSettings = Configuration.GetSection("SmtpSettings").Get<SmtpSettings>();
